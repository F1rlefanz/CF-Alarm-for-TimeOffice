...
## 🆕 Version 1.43.1 (Aktuell – interne Alpha)
...
- **Die Auslieferung an den Testkanal blieb bei mehreren Änderungen auf einmal stehen.** Neue Versionen sollen ohne Klicken beim Tester ankommen. Der Prüfschritt, der die neue Versionsnummer mit der alten vergleicht, schaute dabei aber nur einen Schritt zurück — wurden mehrere Änderungen zusammen veröffentlicht, verglich er die neue Nummer mit sich selbst, fand keinen Unterschied und lieferte nichts aus. Gemeldet hat er das als Erfolg. Er vergleicht jetzt mit dem Stand vor der Veröffentlichung.
