...
Aktueller Stand: **1.23.0** (versionCode 85), verteilt im **internen Alpha-Test**. Die App ist **nicht** öffentlich im Play Store veröffentlicht und geht ausschließlich an eine kleine Gruppe eingeladener Tester (aktuell: Kolleginnen und Kollegen aus der Pflege).
